...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, BUCKET_LA_NEG_Pin|BUCKET_LA_POS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LD1_Pin|LD2_Pin|STEPPER_D_SCS_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = Drive_Button_Pin|Steering_Button_Pin|Scoop_Button_Pin|PlaformRot_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
